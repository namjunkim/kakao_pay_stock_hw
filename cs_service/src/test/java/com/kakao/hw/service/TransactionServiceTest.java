...
public class TransactionServiceTest extends TransactionServiceImpl {
	...
	public void mappingToDtoTransactionHistoryTest() {
		...
		Resource resource = new ClassPathResource("transactionHistory.csv");
		String path = "";
		try {
	...
	public void mappingToDtoBranchInfoDTOTest() {
		...
		Resource resource = new ClassPathResource("branchInfo.csv");
		String path = "";
		try {
			path = resource.getURI().getPath();
		} catch (IOException e) {
	...
	public void divideBusinessHistoryDTOListByBrNameTEST() {
		...
		businessHistoryDTO.setBrCode("A");
		businessHistoryDTO.setAcctName("리노");
		businessHistoryDTO.setBrName("판교점");
		...
		businessHistoryDTO2.setFee(1000L);
		businessHistoryDTO2.setCancellation("N");
		businessHistoryDTO2.setBrCode("B");
		businessHistoryDTO2.setAcctName("제이");
		businessHistoryDTO2.setBrName("분당점");
		...
		for(Map.Entry<String /*brName*/, List<BusinessHistoryDTO>> entry : result.entrySet()) {

			for(BusinessHistoryDTO businessHistory :  entry.getValue()) {
				if("리노".equals(businessHistory.getAcctName())) {
					assertEquals("판교점", entry.getKey());
					assertEquals("리노", businessHistory.getAcctName());
					assertEquals("A", businessHistory.getBrCode());
				} else if("제이".equals(businessHistory.getAcctName())) {
					assertEquals("분당점", entry.getKey());
					assertEquals("제이", businessHistory.getAcctName());
					assertEquals("B", businessHistory.getBrCode());
				}
			}
		}
	}
	...
	@Test
	public void getAmountSumByBranchByYearTEST() {
		...
		businessHistoryDTO2.setBrCode("A");
		businessHistoryDTO2.setAcctName("리노");
		businessHistoryDTO2.setBrName("판교점");
		...
		businessHistoryDTO3.setFee(1000L);
		businessHistoryDTO3.setCancellation("N");
		businessHistoryDTO3.setBrCode("B");
		businessHistoryDTO3.setAcctName("제이");
		businessHistoryDTO3.setBrName("분당점");
		...
		List<AmountSumByBranchByYear> result = 
				transactionService.getAmountSumByBranchByYear(businessHistoryDTOByYear);
		
		for(AmountSumByBranchByYear amountSumByBranchByYear : result) {
			assertEquals("2018", amountSumByBranchByYear.getYear());
			for(AmountSumByBranchByYearData amountSumByBranchByYearData : amountSumByBranchByYear.getAmountSumByBranchByYearDataList()) {
				if("A".equals(amountSumByBranchByYearData.getBrCode())) {
					assertEquals("A", amountSumByBranchByYearData.getBrCode());
					assertEquals("판교점", amountSumByBranchByYearData.getBrName());
					assertEquals(Long.valueOf("1000000"), amountSumByBranchByYearData.getSumAmt());
				} else if("B".equals(amountSumByBranchByYearData.getBrCode())) {
					assertEquals("B", amountSumByBranchByYearData.getBrCode());
					assertEquals("분당점", amountSumByBranchByYearData.getBrName());
					assertEquals(Long.valueOf("2000000"), amountSumByBranchByYearData.getSumAmt());
				}
			}
		}
	}
